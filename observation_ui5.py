...
"color: rgb(242, 242, 242);")
        ...
        self.twIndepVariables.setStyleSheet("QTableWidget::item {\n"
...
"}")
        ...
        self.tabProjectType.setStyleSheet("QTabBar::tab  {\n"
...
"}")
        ...
        self.tab_player_1.setStyleSheet("color: rgb(242, 242, 242);")
        ...
        self.twVideo1.setStyleSheet("QTableWidget::item {\n"
"  selection-background-color: rgb(89, 89, 89);\n"
"  selection-color: rgb(242, 242, 242);\n"
"}\n"
"\n"
...
"}")
        ...
        self.pbAddVideo.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbAddVideo.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_add_media_without_path.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pb_add_media_without_path.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pbRemoveVideo.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbRemoveVideo.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pbAddMediaFromDir.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbAddMediaFromDir.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_add_all_media_from_dir_without_path.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pb_add_all_media_from_dir_without_path.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.tab_player_2.setStyleSheet("color: rgb(242, 242, 242);")
        ...
        self.twVideo2.setStyleSheet("QTableWidget::item {\n"
"  selection-background-color: rgb(89, 89, 89);\n"
"  selection-color: rgb(242, 242, 242);\n"
"}\n"
"\n"
...
"}")
        ...
        self.pbAddVideo_2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbAddVideo_2.setStyleSheet("background-color: rgb(13, 13, 13);")
        self.pbAddVideo_2.setObjectName("pbAddVideo_2")
        self.horizontalLayout_4.addWidget(self.pbAddVideo_2)
        self.pb_add_media_without_path2 = QtWidgets.QPushButton(self.layoutWidget6)
        self.pb_add_media_without_path2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pb_add_media_without_path2.setStyleSheet("background-color: rgb(13, 13, 13);")
        self.pb_add_media_without_path2.setObjectName("pb_add_media_without_path2")
        ...
        self.pbRemoveVideo_2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbRemoveVideo_2.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.tab_data_files.setStyleSheet("color: rgb(242, 242, 242);")
        ...
        self.tw_data_files.setStyleSheet("QTableWidget::item {\n"
"  selection-background-color: rgb(89, 89, 89);\n"
"  selection-color: rgb(242, 242, 242);\n"
"}\n"
"\n"
...
"}")
        ...
        self.pb_add_data_file.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pb_add_data_file.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_add_data_file_wo_path.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pb_add_data_file_wo_path.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_view_data_head.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pb_view_data_head.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_plot_data.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pb_plot_data.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_remove_data_file.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pb_remove_data_file.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pbSave.setStyleSheet("background-color: rgb(13, 13, 13);")
        self.pbSave.setObjectName("pbSave")
        self.horizontalLayout.addWidget(self.pbSave)
        self.pbLaunch = QtWidgets.QPushButton(self.layoutWidget2)
        self.pbLaunch.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbLaunch.setStyleSheet("background-color: rgb(13, 13, 13);")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Nova Observação"))
        self.label.setText(_translate("Form", "Observação id:"))
        ...
        self.lbTimeOffset.setText(_translate("Form", "Deslocamento de tempo"))
        self.rbAdd.setText(_translate("Form", "Adicionar"))
        self.rbSubstract.setText(_translate("Form", "Subtrair"))
        self.leTimeOffset.setText(_translate("Form", "0"))
        self.teTimeOffset.setDisplayFormat(_translate("Form", "hh:mm:ss.zzz"))
        self.label_3.setText(_translate("Form", "Variavéis independentes"))
        item = self.twIndepVariables.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Variável"))
        ...
        self.label_5.setText(_translate("Form", "Caminhos de arquivo de mídia (primeiro player)"))
        item = self.twVideo1.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Caminho"))
        item = self.twVideo1.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Duração"))
        item = self.twVideo1.horizontalHeaderItem(2)
        item.setText(_translate("Form", "FPS"))
        item = self.twVideo1.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Vídeo"))
        item = self.twVideo1.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Áudio"))
        self.pbAddVideo.setText(_translate("Form", "Adicionar mídia"))
        self.pb_add_media_without_path.setText(_translate("Form", "Adicionar mídia sem caminho"))
        self.pbRemoveVideo.setText(_translate("Form", "Remover mídia"))
        self.pbAddMediaFromDir.setText(_translate("Form", "Adicione todas as mídias do diretório"))
        self.pb_add_all_media_from_dir_without_path.setText(_translate("Form", "Adicionar todas as mídias do diretório sem caminho"))
        self.cbVisualizeSpectrogram.setText(_translate("Form", "Visualizar espectrograma"))
        self.cbCloseCurrentBehaviorsBetweenVideo.setText(_translate("Form", "Parar eventos de estado em andamento entre arquivos de mídia sucessivos"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_player_1), _translate("Form", "Player 1"))
        self.label_2.setText(_translate("Form", "Caminhos de arquivo de mídia para o segundo player(serão reproduzidos simultaneamente)"))
        ...
        item.setText(_translate("Form", "Áudio"))
        self.pbAddVideo_2.setText(_translate("Form", "Adicionar mídia"))
        self.pb_add_media_without_path2.setText(_translate("Form", "Adicionar mídia sem caminho"))
        self.pbRemoveVideo_2.setText(_translate("Form", "Remover mídia"))
        self.lbTimeOffset_2.setText(_translate("Form", "Deslocamento de tempo para o segundo jogador"))
        self.rbEarlier.setText(_translate("Form", "Cedo"))
        self.rbLater.setText(_translate("Form", "Tarde"))
        ...
        self.label_7.setText(_translate("Form", "Arquivos de dados para traçar"))
        item = self.tw_data_files.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Caminho"))
        item = self.tw_data_files.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Colunas para traçar"))
        item = self.tw_data_files.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Título do lote"))
        item = self.tw_data_files.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Nome variável"))
        item = self.tw_data_files.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Conversores"))
        item = self.tw_data_files.horizontalHeaderItem(5)
        item.setText(_translate("Form", "Intervalo(s) de tempo"))
        item = self.tw_data_files.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Posição(ões) inicial(is)"))
        item = self.tw_data_files.horizontalHeaderItem(7)
        item.setText(_translate("Form", "Subtrair primeiro valor"))
        item = self.tw_data_files.horizontalHeaderItem(8)
        item.setText(_translate("Form", "Cor"))
        self.pb_add_data_file.setText(_translate("Form", "Adicionar arquivos de dados"))
        self.pb_add_data_file_wo_path.setText(_translate("Form", "Adicionar arquivo de dados sem caminho"))
        self.pb_view_data_head.setText(_translate("Form", "Visualizar as primeiras linhas"))
        self.pb_plot_data.setText(_translate("Form", "mostrar enredo"))
        self.pb_remove_data_file.setText(_translate("Form", "Remover arquivos de dados"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_data_files), _translate("Form", "Arquivos de dados "))
        self.tabProjectType.setTabText(self.tabProjectType.indexOf(self.tabVideo), _translate("Form", "Media"))
        self.label_4.setText(_translate("Form", "Amostragem de digitalização a cada"))
        self.label_6.setText(_translate("Form", "segundos"))
        ...
        self.pbSave.setText(_translate("Form", "Salvar"))
        self.pbLaunch.setText(_translate("Form", "Começar"))
