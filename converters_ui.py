...
class Ui_converters(object):
    def setupUi(self, converters):
        ...
        converters.setWindowIcon(icon)
        converters.setStyleSheet("background-color: rgb(38, 38, 38);\n"
"color: rgb(242, 242, 242);")
        ...
        self.tw_converters.setStyleSheet("QTableWidget::item {\n"
...
"}")
        ...
        self.pb_add_converter.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_modify_converter.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_delete_converter.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_load_from_file.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_load_from_repo.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_code_help.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_save_converter.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_cancel_converter.setStyleSheet("background-color: rgb(13, 13, 13);")
        ...
        self.pb_cancel_widget.setStyleSheet("background-color: rgb(13, 13, 13);")
    ...
    def retranslateUi(self, converters):
        ...
        converters.setWindowTitle(_translate("converters", "Conversores de tempo"))
        self.label_4.setText(_translate("converters", "Conversores"))
        self.tw_converters.setSortingEnabled(True)
        item = self.tw_converters.horizontalHeaderItem(0)
        item.setText(_translate("converters", "Nome"))
        item = self.tw_converters.horizontalHeaderItem(1)
        item.setText(_translate("converters", "Descrição"))
        item = self.tw_converters.horizontalHeaderItem(2)
        item.setText(_translate("converters", "Código"))
        self.pb_add_converter.setText(_translate("converters", "Adicionar novo conversor"))
        self.pb_modify_converter.setText(_translate("converters", "Modificar conversor"))
        self.pb_delete_converter.setText(_translate("converters", "Excluir conversor"))
        self.pb_load_from_file.setText(_translate("converters", "Carregar conversores do arquivo"))
        self.pb_load_from_repo.setText(_translate("converters", "Carregar conversores do repositório BORIS"))
        self.label_2.setText(_translate("converters", "Nome"))
        self.label_3.setText(_translate("converters", "Descrição"))
        self.label.setText(_translate("converters", "Código Python"))
        self.pb_code_help.setText(_translate("converters", "Ajudar"))
        self.pb_save_converter.setText(_translate("converters", "Salvar conversor"))
        self.pb_cancel_converter.setText(_translate("converters", "Cancelar"))
        self.pb_cancel_widget.setText(_translate("converters", "Cancelar"))
