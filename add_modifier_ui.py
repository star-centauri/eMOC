...
"color: rgb(242, 242, 242);")
        ...
        self.select_default = QtWidgets.QPushButton(Dialog)
        self.select_default.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.select_default.sizePolicy().hasHeightForWidth())
        self.select_default.setSizePolicy(sizePolicy)
        self.select_default.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.select_default.setAcceptDrops(False)
        self.select_default.setStyleSheet("background-color: rgb(13, 13, 13);")
        self.select_default.setAutoDefault(True)
        self.select_default.setObjectName("select_default")
        self.horizontalLayout_6.addWidget(self.select_default)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.select_default.setText(_translate("Dialog", "..."))
